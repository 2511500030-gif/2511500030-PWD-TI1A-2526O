    ...
    <html lang="en">
      ...
      <body>
        ...
        <main>
          ...
          unset($_SESSION['flash_sukses'], $_SESSION['flash_eror'], $_SESSION['old']);
          ?>
          ...
          <section id="contact">
            ...
            <?php
            $flash_error_captcha = $_SESSION['error_captcha'] ?? '';
            unset($_SESSION['error_captcha']);
            ?>

            <?php if (!empty($flash_error_captcha)): ?>
            <div style="padding:10px; margin-bottom:10px; background:#f8d7da; color:#721c24; border-radius:6px">
            <?= $flash_error_captcha; ?>
            </div>
            <?php endif; ?>
          ...
          <form action="proses.php" method="POST">
              ...
              <small>Jawab hasil perkalian di atas untuk kirim pesan.</small>
              </label>
